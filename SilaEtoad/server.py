...
from .feature_implementations.etoad_impl import EtoadImpl
from .generated.etoad import EtoadFeature
...
class Server(SilaServer):
    def __init__(self, server_uuid: Optional[UUID] = None):
        ...
        self.etoad = EtoadImpl(self)
        self.set_feature_implementation(EtoadFeature, self.etoad)
