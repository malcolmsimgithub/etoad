...
let
  ...
  atlas = python310Packages.buildPythonPackage rec {
        ...
        src = fetchGit {
          name = "atlas";
          url = "file:///home/malcolm/env/atlas-main";
          rev = "cd12822543a54e97e18abfda1659a1381b22436d";
        };
...
in
  mkShell { buildInputs = with python310Packages; [ notification-apps sila2 packaging streamlit singleton-decorator python-telegram-bot tkinter pandas typer gpytorch botorch matter-chimera matter-golem atlas olympus molar psycopg2 pyunpack patool];
